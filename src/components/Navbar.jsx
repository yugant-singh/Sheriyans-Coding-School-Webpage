...
const Navbar = () => {
  return (
    <div>
       <nav className=' font-[HalveticaLight] flex justify-around items-center p-4  h-20 w-full '>
...
{/* 
 center */}
        ...
        {/* right */}
        <div className='h-full w-[5%] flex gap-5 items-center justify-around'>
            <h4 className='text-lg'><i className="ri-notification-2-fill"></i></h4>
